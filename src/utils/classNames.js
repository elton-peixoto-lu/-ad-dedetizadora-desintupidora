...
export const responsiveClasses = {
  ...
  // Botões responsivos
  button: {
    primary: 'px-4 py-2 md:px-6 md:py-3 lg:px-8 lg:py-4 text-sm md:text-base lg:text-lg rounded-lg bg-green-600 hover:bg-green-700 text-white font-semibold shadow-md',
